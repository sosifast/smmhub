    ...
    <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-4 sm:px-6 lg:px-8 shrink-0 z-10">
      <div className="flex items-center">
          ...
          <div className="hidden sm:flex items-center relative w-64 md:w-80">
              ...
              <input type="text" placeholder="Cari sesuatu..." className="w-full bg-gray-50 border border-gray-200 text-sm rounded-lg pl-10 pr-4 py-2 focus:outline-none focus:ring-1 focus:ring-brand-500 focus:border-brand-500 transition-shadow" />
          </div>
      </div>
      ...
      <div className="flex items-center space-x-3 sm:space-x-5">
          ...
          <div className="flex items-center space-x-3 cursor-pointer">
              <img className="h-9 w-9 rounded-full object-cover ring-2 ring-gray-100" src="https://placehold.co/100x100/2563eb/ffffff?text=AD" alt="Admin Profile" />
