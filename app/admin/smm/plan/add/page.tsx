...
export default function AddSmmPlanPage() {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showToast(`Gagal menambahkan paket: ${error.message}`, "error");
      setIsSaving(false);
    }
  };
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1 ml-9">Buat paket layanan baru untuk pelanggan.</p>
        </div>
      </div>
        ...
        <div className="p-6 sm:p-8 space-y-8">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500">Lengkapi informasi paket langganan di bawah ini.</p>
            </div>
          </div>
